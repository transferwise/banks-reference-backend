...
public class NewTWAddressRequest {
    ...
    public NewTWAddressRequest(){}

    public NewTWAddressRequest(@NotNull final String firstLine, @NotNull final String postCode, @NotNull final String city, final String state, @NotNull final String  country, @NotNull final Long customerId, @NotNull Long profileId, final List<TWOccupation> occupations) {
