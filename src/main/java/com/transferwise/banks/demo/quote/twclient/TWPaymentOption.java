...
import com.transferwise.banks.demo.quote.DisabledReason;
import com.transferwise.banks.demo.quote.Fee;
...
final class TWPaymentOption {
    ...
    public TWPaymentOption() {
    }

    public TWPaymentOption(final String payIn, final String payOut) {
        this.payIn = payIn;
        this.payOut = payOut;
    }
